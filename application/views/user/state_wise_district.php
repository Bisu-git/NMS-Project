...
<body id="page-top">
                    ...
                    <table id="stateDataTable" class="table table-bordered table-striped" width="100%">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><?php echo '<a href="' . site_url("user/Fetchallindata/state_data_page/{$title}/{$tablename}") . '">' . $states_count . '</a>' ?></td>
                            </tr>
                        </tfoot>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let stateName = '<?php echo $title ?>';
            let statecount = '<?php echo $states_count ?>';
            ...
            dataTable = $('#stateDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo site_url('user/Fetchallindata/state_wise_district'); ?>",
                    type: "GET",
                    data: {
