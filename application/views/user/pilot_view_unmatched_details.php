        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Pilot Un-Matched Data</li>
                </ol>

                <h1 class="text-center mb-4">Display Pilot Project Un Matched Data</h1>
                    ...
                    <table id="stateDataTable" class="table table-bordered table-striped" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Latitude</th>
                                <th>Longitude</th>
                                <th>DoT Nodal Officer</th>
                                <th>No. of FTTH Connections</th>
                            </tr>
                        </thead>
                            ...
                            <?php if (!empty($details)) {
                                ...
                                foreach ($details as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row['GP_Name']); ?></td>
                                        <td><?= htmlspecialchars($row['GP_Code']); ?></td>
                                        <td><?= htmlspecialchars($row['Latitude']); ?></td>
                                        <td><?= htmlspecialchars($row['Longitude']); ?></td>
                                        <td><?= htmlspecialchars($row['DoT_Nodal_Officer_Name']); ?></td>
                                        <td><?= htmlspecialchars($row['No_of_FTTH_Connections']); ?></td>
                                    </tr>
                            <?php }
                            } else { ?>
                                <tr>
                                    <td colspan="10" class="text-center">No unmatched data found</td>
                                </tr>
                            <?php } ?>
                        </tbody>
