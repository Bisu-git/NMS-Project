...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <!-- <h1 class="text-center mb-4">Display BBNL State Wise Data</h1> -->
                <h1 class="text-center mb-4">
                    Display BBNL <?php echo ucwords(strtolower($title)); ?>  Data
                </h1>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const stateName = decodeURIComponent(urlParts[5]); // "ANDAMAN AND NICOBAR ISLANDS"
            const tableName = decodeURIComponent(urlParts[6]); // "23_04_2025_10_37_34"
            ...
            dataTable = $('#stateDataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo site_url('user/Fetchallindata/get_state_data_ajax'); ?>",
                    type: "GET",
                    data: {
