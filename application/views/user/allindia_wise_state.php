...
<head>
    ...
    <style>
        ...
        #allindDataTable thead {
            background-color: #343a40;
            color: white;
        }

        #allindDataTable tbody tr:hover {
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <h1 class="text-center mb-4">Display BBNL ALL India Wise Data</h1>
                ...
                <div class="table-responsive">
                    <table id="allindDataTable" class="table table-bordered table-striped" width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>State Name</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let tableName = '<?php echo $tablename ?>';

            console.log("Table Name:", tableName);

            $('#loader').fadeIn();

            dataTable = $('#allindDataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "<?php echo site_url('user/Fetchallindata/get_allindia_data_ajax'); ?>",
                    type: "GET",
                    data: {
